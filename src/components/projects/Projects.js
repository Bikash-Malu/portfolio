    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        <ProjectsCard
          ...
          src={projectOne}
          link="https://github.com/Bikash-Malu/footwear_frontend"
        />
        <ProjectsCard
          ...
          src={projectTwo}
          link="https://github.com/Bikash-Malu/A2Z_Store_frontend"
        />
        <ProjectsCard
          ...
          src={projectThree}
          link="https://github.com/Bikash-Malu/ecommerce_frontend"
        />
